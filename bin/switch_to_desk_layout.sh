...
xrandr --output VIRTUAL1 --off --output eDP1 --off --output DP1 --off --output HDMI2 --off --output HDMI1 --mode 2560x1440 --pos 1440x624 --rotate normal --output DP2 --mode 2560x1440@60 --pos 0x0 --rotate left
